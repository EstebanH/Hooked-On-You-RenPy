...
define dw = DynamicCharacter('dwight_name', window_style="window_killer", color="#cb8830", callback=callbackcontinue, show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
...
define ts = DynamicCharacter('spirit_name', window_style="window_killer", color="#ee496a", callback=callbackcontinue, show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
